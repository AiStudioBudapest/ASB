...
const PATH_A = [
  [0, [0, 30, 262], [0, 88, 0], 44], /* the first screen: the whole Parliament in the lower half, the sky above it for the title (was [0,12,176] -> [0,48,0], building behind the text) */
